...
public class Biblioteca_HashMap
{
   ...
   public static void main ( String argv[]){
       ...
       if ( resu == 0) System.out.println("El libro no está en el catalogo");
            ...
            else System.out.println("Su prestamo ha sido anotado");
       
       System.out.println("Libros disponibles:");
       verCatalogoOrdenado(disponibles);
//hasmap no se puede ver oredenado con un metodo auxiliar para ordenadorlo en un treemap
       System.out.println("Libros prestados:");
   ...
   /*     for (Map.Entry claveLibro: mlibros.entrySet()){
            ...
            n++;  // otr forma de hacer la linea de abajo
         }*/
 ...
 // Creo un arbol ordenado con los datos del HashMap, treemao para que lo ordene
      TreeMap <String,Libro> mlibrosaux =  new TreeMap <String,Libro>(mlibros);
